...
export function DeleteEntityDialog({
  ...
  const entityLabel = entityType === 'client' ? 'Client' : entityType === 'vendor' ? 'Vendor' : entityType === 'asset' ? 'Asset' : entityType === 'loan' ? 'Loan Account' : entityType === 'interest-payment' ? 'Interest Payment' : entityType === 'raw-material' ? 'Raw Material' : entityType === 'trading-good' ? 'Trading Good' : entityType === 'finished-good' ? 'Finished Good' : entityType === 'procurement' || entityType === 'trading_good_procurement' ? 'Procurement' : entityType === 'sale' ? 'Sale' : 'Payment';
