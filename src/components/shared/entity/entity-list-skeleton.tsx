/**
 * EntityListSkeleton Component
 * Generic loading skeleton for entity list (clients/vendors)
 */
...
export function EntityListSkeleton({ view = 'table', count = 6 }: EntityListSkeletonProps) {
  if (view === 'grid') {
    return (
      <motion.div
