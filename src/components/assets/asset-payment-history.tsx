/**
 * AssetPaymentHistory Component
 * Shows payment history for a specific asset
 */
...
interface AssetPaymentHistoryProps {
    assetId: string;
    assetName: string;
}
...
export function AssetPaymentHistory({ assetId, assetName }: AssetPaymentHistoryProps) {
            ...
            <Card>
                ...
                <CardContent>
                    <EmptyState
                        ...
                        description={`No payments have been recorded for ${assetName} yet.`}
                    />
                </CardContent>
            </Card>
        );
