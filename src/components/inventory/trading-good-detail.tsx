      ...
      >
        ...
        <div className="relative space-y-6">
          <div className="flex items-center gap-3 pb-4 border-b border-border/50">
            ...
            <h3 className="text-lg font-semibold">Pricing & Profitability</h3>
          </div>

          <div className="grid gap-6 md:grid-cols-2">
            <div>
              <p className="text-sm text-muted-foreground mb-1">Cost Price</p>
              <p className="text-2xl font-bold">₹{good.costPrice.toFixed(2)}</p>
              <p className="text-sm text-muted-foreground">per {good.unit}</p>
            </div>
            <div>
