...
export default async function FinishedGoodsPage({ searchParams }: PageProps) {
    ...
    <div className="flex-1 flex flex-col gap-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              Manage your production output and inventory levels
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="px-6 md:px-10 space-y-6">
        ...
        <EntitySearchFilterBar
          ...
          addNewPath="/inventory/finished-goods/new"
          addNewLabel="Add Finished Good"
