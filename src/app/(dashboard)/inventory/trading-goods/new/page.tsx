...
import { TradingGoodForm } from '@/components/inventory/trading-good-form';

export default function NewTradingGoodPage() {
  return (
    <div className="flex-1 p-6 md:p-10 min-h-screen">
      <div className="mx-auto w-full max-w-4xl">
        ...
        <div className="relative mb-12">
          ...
          <h1 className="text-4xl font-extrabold tracking-tight">Add Trading Good</h1>
          <p className="text-base text-muted-foreground mt-2">
            Create a new trading good entry in your inventory
          </p>
        </div>
