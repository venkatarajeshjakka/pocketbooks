    ...
    <div className="flex-1 saas-canvas p-6 md:p-10 min-h-screen">
      ...
      <div className="mx-auto w-full max-w-4xl mb-10">
        ...
        <div className='relative'>
          ...
          <h1 className="text-4xl font-extrabold tracking-tight text-foreground/90 sm:text-5xl">Add New Vendor</h1>
          <p className="text-base text-muted-foreground mt-3 font-medium max-w-2xl leading-relaxed">
            Create a new vendor profile. Specify their specialties and raw material types to optimize your procurement workflow.
          </p>
        </div>
      </div>
